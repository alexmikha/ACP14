...
import week3.utils.OpenWeatherResponse;
...
public class WeatherApiImpl implements WeatherApi {
    ...
    private static final String GET_CITY_INFO_URL ="http://api.openweathermap.org/data/2.5/weather?q=%s&APPID=%s"; //http://api.openweathermap.org/data/2.5/weather?q=%s&APPID=%s";
